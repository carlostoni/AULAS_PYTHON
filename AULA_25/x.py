...
# Criando um Frame para organizar os botões lado a lado
btn_frame = tk.Frame(root)
btn_frame.pack()

btn_read = tk.Button(btn_frame, text='Ler', command=read, width=15)
btn_read.pack(side=tk.LEFT)

btn_update = tk.Button(btn_frame, text='Atualizar', command=update, width=15)
btn_update.pack(side=tk.LEFT)

btn_delete = tk.Button(btn_frame, text='Deletar', command=delete, width=15)
